...
% save('results_lrr_multi_cluster.mat', 'clusters', 'labels', 'predicted_labels', 'the_nmi_value', 'the_ari_value', 'purity','elapsed_time');
% save('results_lrr_dependent_subspaces.mat', 'clusters', 'labels', 'predicted_labels', 'the_nmi_value', 'the_ari_value', 'purity','elapsed_time');
rmpath(paths);
